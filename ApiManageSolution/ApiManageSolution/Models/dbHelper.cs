...
namespace ApiManageSolution.Models
{
    public class dbHelper
    {
        ...
        private static string ConnectionStringDefault = "Server=172.168.1.244;Port=5444;Database=ms_root;User Id=msolution;Password=msolution;TIMEOUT=15;POOLING=True;MINPOOLSIZE=1;MAXPOOLSIZE=20;COMMANDTIMEOUT=20;";
