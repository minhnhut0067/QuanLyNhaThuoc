        ...
        switch (v_this.id) {
            ...
            case "page_nhansu_khaibaonhanvien_ngaysinh":
                ...
                if (ms_gval("page_nhansu_khaibaonhanvien_ngaysinh", "value", "") != "") {
                    ms_sval("page_nhansu_khaibaonhanvien_namsinh", "value", ms_gval("page_nhansu_khaibaonhanvien_ngaysinh", "value", "").substr(6, 4));
                }
                break;
...
function btn_click(v_this) {
    switch (v_this.id) {
        ...
        case "page_nhansu_khaibaonhanvien_themmoi":
            f_set_val("page_nhansu_khaibaonhanvien_id", "nhanviens", "id");
            f_clear_arr("nhanviens");
        ...
        case "page_nhansu_khaibaonhanvien_xoa":
            f_gridview_del_record("nhanviens", ms_gval("page_nhansu_khaibaonhanvien_id", "selectedvalue"));
            f_clear_arr("nhanviens");
            ms_enable_arr("page_nhansu_khaibaonhanvien_sua", false);
            break;
...
function f_save_nhanvien() {
    try {
        ...
        if (ms_gval("page_nhansu_khaibaonhanvien_hoten", "value") == "") {
            ...
            ms_focus("page_nhansu_khaibaonhanvien_hoten");
            return null;
        }
        if (ms_gval("page_nhansu_khaibaonhanvien_phai", "selectedvalue") == "") {
            alert("Vui lòng chọn giới tính");
            ms_focus("page_nhansu_khaibaonhanvien_phai");
            return null;
        }
        if (ms_gval("page_nhansu_khaibaonhanvien_phongban", "selectedvalue") == "") {
            alert("Vui lòng chọn phòng ban");
            ms_focus("page_nhansu_khaibaonhanvien_phongban");
            return null;
        }
        if (ms_gval("page_nhansu_khaibaonhanvien_namsinh", "value") == "") {
            alert("Vui lòng nhập năm sinh");
            ms_focus("page_nhansu_khaibaonhanvien_namsinh");
            return null;
        }
        data = {
            id: ms_gval("page_nhansu_khaibaonhanvien_id", "selectedvalue"),
            hoten: ms_gval("page_nhansu_khaibaonhanvien_hoten", "value"),
            ngaysinh: ms_gval("page_nhansu_khaibaonhanvien_ngaysinh", "value"),
            namsinh: ms_gval("page_nhansu_khaibaonhanvien_namsinh", "value"),
            diachi: ms_gval("page_nhansu_khaibaonhanvien_diachi", "value"),
            sdt: ms_gval("page_nhansu_khaibaonhanvien_sdt", "selectedvalue"),
            email: ms_gval("page_nhansu_khaibaonhanvien_email", "value"),
            capbac: ms_gval("page_nhansu_khaibaonhanvien_capbac", "value"),
            mucluong: ms_gval("page_nhansu_khaibaonhanvien_mucluong", "value"),
            idphai: ms_gval("page_nhansu_khaibaonhanvien_phai", "selectedvalue"),
            tenphai: ms_gval("page_nhansu_khaibaonhanvien_phai", "value"),
            idphongban: ms_gval("page_nhansu_khaibaonhanvien_phongban", "selectedvalue"),
            tenphongban: ms_gval("page_nhansu_khaibaonhanvien_phongban", "value")
        };
        url = "SaveNhanvien";
        f_save_data(url, data);
...
function f_nhanvien_show(v_ds, v_index, v_bool) {
    ...
    ms_sval("page_nhansu_khaibaonhanvien_capbac", "value", ms_gfields(v_ds, v_index, "capbac", ""));
    ms_sval("page_nhansu_khaibaonhanvien_mucluong", "value", ms_gfields(v_ds, v_index, "mucluong", ""));
